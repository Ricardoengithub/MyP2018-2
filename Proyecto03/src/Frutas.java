...
/** Creates a new instance of Frutas */
public Frutas(int n) {
...
animales[12] = "nuez";
animales[13] = "cereza";
animales[14] = "arandano";
animales[15] = "mango";
animales[16] = "manzana";
animales[17] = "pera";
animales[18] = "mandarina";
animales[19] = "kiwi";
this.animales = animales;

imagenes = new String[20];//Añadimos los nombres de los archivos de las imagenes.
imagenes[0] = "guayaba.png";
imagenes[1] = "zapote.png";
imagenes[2] = "durazno.png";
imagenes[3] = "coco.png";
imagenes[4] = "fresa.png";
imagenes[5] = "tuna.png";
imagenes[6] = "chirimoya.png";
imagenes[7] = "higo.png";
imagenes[8] = "lichi.png";
imagenes[9] = "ciruela.png";
imagenes[10] = "naranja.png";
imagenes[11] = "banana.png"; 
imagenes[12] = "nuez.png";
imagenes[13] = "cereza.png";
imagenes[14] = "arandano.png";
imagenes[15] = "mango.png";
imagenes[16] = "manzana.png";
imagenes[17] = "pera.png";
imagenes[18] = "mandarina.png";
imagenes[19] = "kiwi.png";
...
setTitle("Frutas( " + animalesSeleccionados[0] + "-" + animalesSeleccionados[1] + "-" + animalesSeleccionados[2] + "-" + animalesSeleccionados[3] + "-" + animalesSeleccionados[4] + "-" + animalesSeleccionados[5] + "-" + animalesSeleccionados[6] + "-" + animalesSeleccionados[7]+" )" );
