...
/** Creates a new instance of Paises */
public Paises(int n) {
...
animales[16] = "belgica";
animales[17] = "austria";
animales[18] = "australia";
animales[19] = "argentina";
this.animales = animales;

imagenes = new String[20];//Añadimos los nombres de los archivos de las imagenes.
imagenes[0] = "peru.png";
imagenes[1] = "croacia.png";
imagenes[2] = "portugal.png";
imagenes[3] = "panama.png";
imagenes[4] = "españa.png";
imagenes[5] = "mexico.png";
imagenes[6] = "francia.png";
imagenes[7] = "italia.png";
imagenes[8] = "jamaica.png";
imagenes[9] = "japon.png";
imagenes[10] = "colombia.png";
imagenes[11] = "china.png"; 
imagenes[12] = "chile.png";
imagenes[13] = "cuba.png";
imagenes[14] = "canada.png";
imagenes[15] = "brazil.png";
imagenes[16] = "belgica.png";
imagenes[17] = "austria.png";
imagenes[18] = "australia.png";
imagenes[19] = "argentina.png";
...
setTitle("Paises( " + animalesSeleccionados[0] + "-" + animalesSeleccionados[1] + "-" + animalesSeleccionados[2] + "-" + animalesSeleccionados[3] + "-" + animalesSeleccionados[4] + "-" + animalesSeleccionados[5] + "-" + animalesSeleccionados[6] + "-" + animalesSeleccionados[7]+" )" );
